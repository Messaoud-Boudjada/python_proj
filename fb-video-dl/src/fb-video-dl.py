...
#retrieves video id
def get_fvID(fburl):
    regex = 'http[s]?://www.facebook.[a-z]{2,3}/video.php\?v=([0-9]+)*'
...
#you need documntation on this this part and do  quick documetation on you labrary
